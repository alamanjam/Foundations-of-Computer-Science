public class StudentHoursGreaterThan21 implements Hours
 { 
   String myFirstName, myLastName, myRoomType, myGrad, myWarning, gr; 
   int myCredHours, myFees, n, g;
    
     
    public StudentHoursGreaterThan21() 
    { 
      myFirstName = ""; 
      myLastName = ""; 
      myRoomType = "";
    ...
    public StudentHoursGreaterThan21(String lastName, String firstName, int credHours, String roomType, String grad, String warning) 
    { 
